        ...
        <td colspan="8">
        	<div class="pagelist"> 
        		<c:if test="${pageInfo.hasPreviousPage }">
	        		<a href="${pageContext.request.contextPath }/question/searchResolved.do?page=${pageInfo.pageNum-1}&keywords=${keywords}">上一页</a> 
        		</c:if>
        		...
        		<c:forEach var="idx" items="${pageInfo.navigatepageNums }">
        			<c:choose>
		        		...
		        		<c:otherwise>
		        			<a href="${pageContext.request.contextPath }/question/searchResolved.do?page=${idx}&keywords=${keywords}">${idx }</a>
		        		</c:otherwise>
	        		</c:choose>
        		</c:forEach>
        		
        		<c:if test="${pageInfo.hasNextPage }">
        			<a href="${pageContext.request.contextPath }/question/searchResolved.do?page=${pageInfo.pageNum+1}&keywords=${keywords}">下一页</a>
        		</c:if>
        	</div>
        </td>
      </tr>
