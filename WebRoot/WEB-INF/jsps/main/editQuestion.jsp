...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-pencil-square-o"></span> 修改问题</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="${pageContext.request.contextPath }/question/edit.do?code=${question.code}">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input id="title" type="text" class="input" name="title" value="${question.title }" />
          <div class="tips"></div>
        </div>
      </div>
      <%-- 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea id="content" name="content" class="input" style="height:120px;">${question.content }</textarea>
          <div class="tips"></div>
        </div>
      </div>
      <%-- 
